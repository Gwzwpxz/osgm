...
ALG_HDM_BETA_RANGE_UPPER = "HDM BETA RANGE UPPER"
ALG_HDM_BETA_RANGE_LOWER = "HDM BETA RANGE LOWER"

# Candidate scaling matrix set
ALG_HDM_VERSION = "HDM VERSION"
...
hdm_params = {
    ...
    ALG_HDM_BETA_RANGE_UPPER: 1.0,
    ALG_HDM_BETA_RANGE_LOWER: -1.0,
    ALG_HDM_VERSION: ALG_HDM_VERSION_DIAG
}
