...
parser.add_argument('--dataset', type=str, default='./problems/a2a', help='Path to the dataset')
...
if __name__ == "__main__":
    ...
    # Construct gradient descent without descent parameters
    adpgd_param_base = adpgd_params.copy()
    adpgd_search_grid = {
        ALG_ADP_GD_LR0: [0.1 / L_est, 1.0 / L_est, 10.0 / L_est, 100.0 / L_est, 1000.0 / L_est]
    }
    ...
    alg_list = {
        ...
        "GD-LS": [GradientDescentLS, gradient_descent_params, None],
        "AGD-CVX": [AcceleratedGradientCvx, accelerated_gradient_descent_cvx_params, None],
        "AGD-CVXLS": [AcceleratedGradientCvxLS, accelerated_gradient_descent_cvx_params, None],
        "ADPGD": [AdpGD, adpgd_param_base, adpgd_search_grid],
        "ADPGDACC": [AdpGDAcc, adpgd_acc_params, None],
